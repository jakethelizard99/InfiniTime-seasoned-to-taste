...
WatchFaceDigital::WatchFaceDigital(DisplayApp* app,
  ...
  lv_obj_set_style_local_text_color(label_seconds_first, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x24FF00));
  ...
  lv_obj_set_style_local_text_color(label_seconds_second, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, lv_color_hex(0x24FF00));
