...
List::List(uint8_t screenID,
  ...
  for (int i = 0; i < MAXLISTITEMS; i++) {
    ...
    if (applications[i].application != Apps::None) {
      ...
      lv_obj_set_style_local_bg_color(itemApps[i], LV_BTN_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_MAKE(0x0, 0xE2, 0x4A));
      ...
      lv_obj_set_style_local_text_color(labelBtIco, LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_GRAY);
